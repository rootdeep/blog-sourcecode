...
![mount_tmpfs](/Linux-Cache-Analysis/atop.png)
...
![drop_cache](/Linux-Cache-Analysis/drop_cache.png)
...
![rm_tmpfs](/Linux-Cache-Analysis/rm_testfile.png)
...
![dd_mmap](/Linux-Cache-Analysis/dd_mmap.png)



然后执行测试程序

![run_test](/Linux-Cache-Analysis/run_test.png)

我们可以看到，在程序执行期间，cached一直为543M(542M)，比之前涨了300M，并且此时这段cache仍然无法被回收。然后我们等待100秒之后程序结束。

![test_result](/Linux-Cache-Analysis/test_result.png)
